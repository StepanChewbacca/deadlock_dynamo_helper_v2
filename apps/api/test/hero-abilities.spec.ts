import { isAbilityItem, mapAbilityToSkillNumber } from '../src/deadlock-live/hero-abilities';
...
describe('hero-abilities', () => {
  ...
  it('returns 1 for unknown ability IDs (existing fallback behavior)', () => {
    expect(mapAbilityToSkillNumber(12, 999999999)).toBe(1);
    expect(mapAbilityToSkillNumber(99, 12345)).toBe(1);
  });
});
